...
import { CardBody, Button, Text } from '@apeswapfinance/uikit'
    ...
    <>
      <AppBody>
        <PageHeader title={t('Liquidity')} description={t('Add liquidity to receive LP tokens')}>
          <Button id="join-pool-button" as={Link} to="/trade/add/ETH" textTransform="uppercase">
            {t('Add Liquidity')}
          </Button>
        </PageHeader>
            ...
            <AutoColumn gap="12px" style={{ width: '100%' }}>
              ...
              <div>
                <Text fontSize="14px" style={{ padding: '.5rem 0 .5rem 0' }}>
                  ...
                  <StyledInternalLink id="import-pool-link" to={hasV1Liquidity ? '/trade/migrate/v1' : '/trade/find'}>
                    {hasV1Liquidity ? t('Migrate now.') : t('Import it.')}
                  </StyledInternalLink>
                </Text>
                <Text fontSize="14px" style={{ padding: '.5rem 0 .5rem 0' }}>
                  {t('Or, if you staked your WINE-LP tokens in a farm, unstake them to see them here.')}
                </Text>
              </div>
            </AutoColumn>
          </CardBody>
