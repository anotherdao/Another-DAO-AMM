...
import { Card as UIKitCard, CardBody, Button, Text } from '@apeswapfinance/uikit'
          ...
          <AutoColumn gap="8px">
            ...
            <RowBetween marginTop="10px">
              <Button
                ...
                as={Link}
                to={`/trade/add/${currencyId(currency0)}/${currencyId(currency1)}`}
                style={{ width: '48%' }}
              >
                Add
              </Button>
              <Button
                ...
                as={Link}
                style={{ width: '48%' }}
                to={`/trade/remove/${currencyId(currency0)}/${currencyId(currency1)}`}
              >
                Remove
              </Button>
            </RowBetween>
