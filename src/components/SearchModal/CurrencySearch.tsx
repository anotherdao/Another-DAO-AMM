...
import { Text, CloseIcon, WarningIcon, IconButton } from '@apeswapfinance/uikit'
        ...
        {showTokensBuidl && (
          <SectionManage>
            <ButtonText
              ...
              color="warning"
              onClick={() => window.open('https://winery.gitbook.io/internal-wiki/welcome/what-is-winery')}
            >
              <RowFixed>
                ...
                <Text fontSize="14px" style={{ textAlign: 'center' }} color="warning">
                  {t('DYOR - BUILD tokens are not YET partners')}
                </Text>
              </RowFixed>
            </ButtonText>
          </SectionManage>
        ...
        <SectionManage>
          <ButtonText className="list-token-manage-button" onClick={() => setShowTokensBuidl(!showTokensBuidl)}>
            <RowFixed>
              ...
              <Text fontSize="14px">
                {showTokensBuidl ? <span>{t('Winery Core Tokens')}</span> : <span>{t('BUILD Tokens')}</span>}
              </Text>
            </RowFixed>
          </ButtonText>
        </SectionManage>
        ...
        <>
          ...
          <Card>
            <RowBetween>
              ...
              <LinkStyledButton
                style={{ fontWeight: 500, color: theme.colors.text, fontSize: 16 }}
